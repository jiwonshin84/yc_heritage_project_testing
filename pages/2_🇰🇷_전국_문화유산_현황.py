...
if df is not None:
    ...
    📌 영천시 특화 분석 및 경쟁력 진단 (Radar & Density)
        ...
        🎯종목 특징 - 영천시가 보유한 문화유산의 종목별 강점을 분석하여 지역 특화 콘텐츠 개발을 위한 기초 데이터를 제공합니다.
    
        🌀밀도 분석 - 2025년 최신 인구 데이터 대비 유산 보유량을 산출하여 인구 소멸 위기 속 문화유산의 보존 가치와 잠재적 밀도를 측정하였습니다. 특히 경북 내 타 시군 대비 영천시의 문화적 위상과 자산 효율성을 한눈에 비교할 수 있도록 설계했습니다.
